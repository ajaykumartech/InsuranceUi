...
//   constructor(private service: UserenvironmentsService, private router : Router, private activatedRoute: ActivatedRoute    ) { }
...
//   var token = localStorage.getItem('Token');
// this.data.SearchText=this.search
// this.service.getsearchcustomer(this.data, token).subscribe(response => {
//   this.customerdata1 = response;
...
//   onClick(event:any, cuid:any){
//     var token = localStorage.getItem('Token')
//     console.log("this is policy: ", event.target.firstChild)
//     this.customername = event.target.firstChild;
//     this.shareCheckedList.emit(cuid);
//     // this.router.navigate(['', cuid])  
//     // console.log("token: ", token)
//     // this.service.getcustomerDetails(cuid, token).subscribe(response =>{
//     //   this.customerdetails = response;
//     //   console.log("customer details from Json-server: ", this.customerdetails)
